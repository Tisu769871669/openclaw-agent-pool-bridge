...
function printHelp(stdout) {
  writeLine(stdout, [
    ...
    "",
    "Alias:",
    "  gents-pool is also available as a forgiving alias when installed from package.json.",
    "",
    "Commands:",
    "  scan                  Discover local OpenClaw workspaces, agent dirs, and openclaw agents list.",
    "                        中文：扫描本机 workspace、agent 目录和 OpenClaw agent 列表。",
    "  setup                 Configure logical agents, worker count, templates, workers, and optional service restart.",
    "                        中文：交互式配置客服池、模板目录、worker 数量，并可创建 worker。",
    "  status                Print the static agent-pool.config.json mapping.",
    "                        中文：查看静态配置，不代表运行态 busy 状态。",
    "  pool                  Show live worker busy state, sticky sessions, queue depth, and recent errors.",
    "                        中文：查看线上运行态，排查并发、卡住和排队问题。",
    "  sync <logicalAgent>   Refresh template and worker workspaces for one logical agent.",
    "                        中文：同步某个客服的模板 workspace 和 worker workspace。",
    "  doctor                Check OpenClaw CLI, config, templates, and worker workspaces.",
    "                        中文：做上线前或故障排查的环境检查。",
    "  help                  Show this help.",
    "                        中文：显示全部命令和说明。",
    "",
